# Privacy Policy — Markonator

**Last updated: 2026-06-28**

Markonator is a local-first tool for reviewing Markdown files. This policy
applies to both the web app and the Chrome extension.

## Data we collect

**None.** Markonator does not collect, transmit, or sell any personal data or
...
**None.** Markonator makes no network requests at all. The Markdown renderer
...
Open an issue at https://github.com/gokuljeyapaul/markonator (the repository may
